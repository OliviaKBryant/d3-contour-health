...
let majorCities = [];
let heatPromises = [
    d3.csv("data/county_health_rankings.csv"),
    d3.csv("data/state_health_rankings.csv"),
    d3.csv("data/contourParameter.csv"),
    d3.csv('data/major-cities.csv')
];
console.log(heatPromises)
        ...
        countyData.push(
            {
                ...
                PercentageSingleParent: parseInt(values[0][i].PcChildSingleParentHousehold),
                Latitude: latitude,
